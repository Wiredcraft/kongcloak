...
Kong can interface with either Cassandra or Postgres. For this tutorial, we'll use Cassandra.
...
```sh
$ curl -X POST http://localhost:8001/consumers --data "username=demo"
```
